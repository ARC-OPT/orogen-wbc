...
namespace wbc{
    ...
    /*! \class HierarchicalLSSolverTask
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','wbc::HierarchicalLSSolverTask')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for HierarchicalLSSolverTask
        ...
        /** Default deconstructor of HierarchicalLSSolverTask
         */
