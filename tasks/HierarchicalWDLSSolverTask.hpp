...
namespace wbc {
    ...
    /*! \class HierarchicalWDLSSolverTask 
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','wbc::HierarchicalWDLSSolverTask')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for HierarchicalWDLSSolverTask
        ...
        /** Default deconstructor of HierarchicalWDLSSolverTask
         */
