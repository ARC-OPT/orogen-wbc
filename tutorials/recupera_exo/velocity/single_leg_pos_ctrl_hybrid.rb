...
Orocos.run "wbc::WbcTask"                          => "recupera_exo_wbc",
           "wbc::LoopBackDriver"                   => "recupera_exo_joints",
           "ctrl_lib::CartesianPositionController" => "recupera_exo_leg_ctrl",
           "hyrodyn::ForwardTask"                  => "recupera_exo_hyrodyn_fk" do

    controller   = Orocos::TaskContext.get "recupera_exo_leg_ctrl"
    wbc          = Orocos::TaskContext.get "recupera_exo_wbc"
    joints       = Orocos::TaskContext.get "recupera_exo_joints"
    hyrodyn      = Orocos::TaskContext.get "recupera_exo_hyrodyn_fk"

    Orocos.conf.apply(wbc,         ["default", "velocity", "recupera_exo_hybrid", "single_leg_ctrl"])
    Orocos.conf.apply(controller,  ["single_leg_cart_ctrl"])
    Orocos.conf.apply(joints,      ["recupera_exo_hybrid"])
    Orocos.conf.apply(hyrodyn,     ["recupera_exo"])
    ...
    # visualization
    proxy = Orocos::Async.proxy "recupera_exo_joints"
