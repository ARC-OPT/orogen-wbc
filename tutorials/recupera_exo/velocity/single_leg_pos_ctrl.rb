...
Orocos.run "wbc::WbcTask"                          => "recupera_exo_wbc",
           ...
           "ctrl_lib::CartesianPositionController" => "recupera_exo_leg_ctrl" do
    ...
    Orocos.conf.apply(wbc,         ["default", "velocity", "recupera_exo", "single_leg_ctrl"])
    Orocos.conf.apply(controller,  ["single_leg_cart_ctrl"])
    Orocos.conf.apply(joints,      ["recupera_exo"])
